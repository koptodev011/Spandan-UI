	...
	theme: {
		...
		extend: {
			colors: {
				...
				session: {
					remote: 'hsl(var(--session-remote))',
					'remote-foreground': 'hsl(var(--session-remote-foreground))',
					clinic: 'hsl(var(--session-clinic))',
					'clinic-foreground': 'hsl(var(--session-clinic-foreground))'
				},
				status: {
